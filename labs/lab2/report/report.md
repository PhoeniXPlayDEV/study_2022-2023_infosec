...
Запустить этот скрипт можно с помощью команды [**cmd:** *sh test.sh 000 000*]. Таким образом, он снимет все права для файла file1 и каталога dir1 и покажет какие действия можно будет над ними выполнить (рис. [-@fig:12]). 

![Запуск bash-скрипта](image/img_12.jpg){ #fig:12 width=70% }
